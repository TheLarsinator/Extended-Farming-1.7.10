...
public class ItemRendererTractor implements IItemRenderer
{
    ...
    public ItemRendererTractor(EntityTractor Tractor, ModelBase model, ResourceLocation texture)
    {
        this.Tractor = Tractor;
        this.modelTractor = model;
        this.texture = texture;
    }

    protected void renderTractor(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX, float translateY, float translateZ)
    {
        GL11.glPushMatrix();
        this.transform(item, type);
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(this.texture);
        this.modelTractor.render(this.Tractor, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
        GL11.glPopMatrix();
    }
    ...
    public void transform(ItemStack itemstack, ItemRenderType type)
    {
        ...
        long var10 = this.Tractor.getEntityId() * 493286711L;
        ...
        if (type == ItemRenderType.EQUIPPED)
        {
            ...
            if (player != null && player.ridingEntity != null && player.ridingEntity instanceof EntityTractor)
            {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        {
            case EQUIPPED:
                this.renderTractor(type, (RenderBlocks) data[0], item, -0.5f, -0.5f, -0.5f);
                break;
