...
public class ItemRendererBody implements IItemRenderer
{
    protected EntityBody Body;
    protected ModelBase modelBody;

    protected static RenderItem drawItems = new RenderItem();

    protected ResourceLocation texture;

    public ItemRendererBody(EntityBody Body, ModelBase model, ResourceLocation texture)
    {
        this.Body = Body;
    ...
    protected void renderBody(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX, float translateY, float translateZ)
    {
        GL11.glPushMatrix();
        this.transform(item, type);
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(this.texture);
        this.modelBody.render(this.Body, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
        GL11.glPopMatrix();
    }
    ...
    public void transform(ItemStack itemstack, ItemRenderType type)
    {
        ...
        long var10 = this.Body.getEntityId() * 493286711L;
        ...
        if (type == ItemRenderType.EQUIPPED)
        {
            ...
            if (player != null && player.ridingEntity != null && player.ridingEntity instanceof EntityBody)
            {
...
/*
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        {
            case EQUIPPED:
                this.renderBody(type, (RenderBlocks) data[0], item, -0.5f, -0.5f, -0.5f);
                break;
