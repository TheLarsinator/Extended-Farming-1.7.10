...
public class ItemRendererWheel implements IItemRenderer
{
    protected EntityWheel Wheel;
    protected ModelBase modelWheel;

    protected static RenderItem drawItems = new RenderItem();

    protected ResourceLocation texture;

    public ItemRendererWheel(EntityWheel Wheel, ModelBase model, ResourceLocation texture)
    {
        this.Wheel = Wheel;
    ...
    protected void renderWheel(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX, float translateY, float translateZ)
    {
        GL11.glPushMatrix();
        this.transform(item, type);
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(this.texture);
        this.modelWheel.render(this.Wheel, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
        GL11.glPopMatrix();
    }
    ...
    public void transform(ItemStack itemstack, ItemRenderType type)
    {
        ...
        long var10 = this.Wheel.getEntityId() * 493286711L;
        ...
        if (type == ItemRenderType.EQUIPPED)
        {
            ...
            if (player != null && player.ridingEntity != null && player.ridingEntity instanceof EntityWheel)
            {
        ...
        if (type == ItemRenderType.EQUIPPED_FIRST_PERSON)
        {
            ...
            GL11.glTranslatef(0.4F, 0.45F, 0.2F);
...
/*
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        {
            case EQUIPPED:
                this.renderWheel(type, (RenderBlocks) data[0], item, -0.5f, -0.5f, -0.5f);
                break;
