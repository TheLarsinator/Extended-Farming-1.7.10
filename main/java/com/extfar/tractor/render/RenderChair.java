...
public class RenderChair extends Render
{
	...
	public RenderChair(ModelBase model)
	{
		this.model = model;
	}

	public void doRenderCar(EntityChair car, double x, double y, double z, float rotationYaw, float par1)
	{
		if (!car.isDead)
		{
			GL11.glPushMatrix();
	...
	{
		doRenderCar((EntityChair) entity, x, y, z, rotationYaw, par1);
	}
