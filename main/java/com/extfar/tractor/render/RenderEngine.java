...
public class RenderEngine extends Render
{
	...
	public RenderEngine(ModelBase model)
	{
		this.model = model;
	}

	public void doRenderCar(EntityEngine car, double x, double y, double z, float rotationYaw, float par1)
	{
		if (!car.isDead)
		{
			GL11.glPushMatrix();
	...
	{
		doRenderCar((EntityEngine) entity, x, y, z, rotationYaw, par1);
	}
