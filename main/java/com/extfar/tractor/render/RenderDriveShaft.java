...
public class RenderDriveShaft extends Render
{
	public ModelBase model;

	
	public RenderDriveShaft(ModelBase model)
	{
		this.model = model;
	}

	public void doRenderCar(EntityDriveShaft car, double x, double y, double z, float rotationYaw, float par1)
	{
		if (!car.isDead)
		{
			GL11.glPushMatrix();
	...
	{
		doRenderCar((EntityDriveShaft) entity, x, y, z, rotationYaw, par1);
	}

	@Override
	public ResourceLocation getEntityTexture(Entity entity) 
	{
		EntityDriveShaft DriveShaft = (EntityDriveShaft)entity;
		return DriveShaft.DriveShaftTexture;
	}
