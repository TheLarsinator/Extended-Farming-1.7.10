...
public class RenderWheel extends Render
{
	...
	public RenderWheel(ModelBase model)
	{
		this.model = model;
	}

	public void doRenderCar(EntityWheel car, double x, double y, double z, float rotationYaw, float par1)
	{
		if (!car.isDead)
		{
			GL11.glPushMatrix();
	...
	{
		doRenderCar((EntityWheel) entity, x, y, z, rotationYaw, par1);
	}
