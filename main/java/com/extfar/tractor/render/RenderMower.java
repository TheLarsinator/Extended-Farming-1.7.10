...
public class RenderMower extends Render
{
	public ModelBase model;

	
	public RenderMower(ModelBase model)
	{
		this.model = model;
	}

	public void doRenderCar(EntityMower car, double x, double y, double z, float rotationYaw, float par1)
	{
		if (!car.isDead)
		{
			GL11.glPushMatrix();
	...
	{
		doRenderCar((EntityMower) entity, x, y, z, rotationYaw, par1);
	}

	@Override
	public ResourceLocation getEntityTexture(Entity entity) 
	{
		EntityMower Mower = (EntityMower)entity;
		return Mower.MowerTexture;
	}
