...
public class RenderSteeringWheel extends Render
{
	public ModelBase model;

	
	public RenderSteeringWheel(ModelBase model)
	{
		this.model = model;
	}

	public void doRenderCar(EntitySteeringWheel car, double x, double y, double z, float rotationYaw, float par1)
	{
		if (!car.isDead)
		{
			GL11.glPushMatrix();
	...
	{
		doRenderCar((EntitySteeringWheel) entity, x, y, z, rotationYaw, par1);
	}

	@Override
	public ResourceLocation getEntityTexture(Entity entity) 
	{
		EntitySteeringWheel SteeringWheel = (EntitySteeringWheel)entity;
		return SteeringWheel.SteeringWheelTexture;
	}
