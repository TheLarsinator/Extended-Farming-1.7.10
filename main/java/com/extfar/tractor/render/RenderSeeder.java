...
public class RenderSeeder extends Render
{
	public ModelBase model;

	
	public RenderSeeder(ModelBase model)
	{
		this.model = model;
	}

	public void doRenderCar(EntitySeeder car, double x, double y, double z, float rotationYaw, float par1)
	{
		if (!car.isDead)
		{
			GL11.glPushMatrix();
	...
	{
		doRenderCar((EntitySeeder) entity, x, y, z, rotationYaw, par1);
	}

	@Override
	public ResourceLocation getEntityTexture(Entity entity) 
	{
		EntitySeeder Seeder = (EntitySeeder)entity;
		return Seeder.SeederTexture;
	}
