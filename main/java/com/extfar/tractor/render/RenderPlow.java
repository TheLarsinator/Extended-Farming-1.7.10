...
public class RenderPlow extends Render
{
	public ModelBase model;

	
	public RenderPlow(ModelBase model)
	{
		this.model = model;
	}

	public void doRenderCar(EntityPlow car, double x, double y, double z, float rotationYaw, float par1)
	{
		if (!car.isDead)
		{
			GL11.glPushMatrix();
	...
	{
		doRenderCar((EntityPlow) entity, x, y, z, rotationYaw, par1);
	}

	@Override
	public ResourceLocation getEntityTexture(Entity entity) 
	{
		EntityPlow Plow = (EntityPlow)entity;
		return Plow.PlowTexture;
	}
