...
public class RenderBody extends Render
{
	public ModelBase model;

	
	public RenderBody(ModelBase model)
	{
		this.model = model;
	}

	public void doRenderCar(EntityBody car, double x, double y, double z, float rotationYaw, float par1)
	{
		if (!car.isDead)
		{
			GL11.glPushMatrix();
	...
	{
		doRenderCar((EntityBody) entity, x, y, z, rotationYaw, par1);
	}

	@Override
	public ResourceLocation getEntityTexture(Entity entity) 
	{
		EntityBody Body = (EntityBody)entity;
		return Body.BodyTexture;
	}
