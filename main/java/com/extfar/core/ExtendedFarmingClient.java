...
import com.extfar.tractor.itemrenderer.ItemRendererHarvester;
...
import com.extfar.tractor.model.ModelHarvester;
...
public class ExtendedFarmingClient extends ExtendedFarmingProxy{
	...
	public void registerRenderInformation()
		...
		MinecraftForgeClient.registerItemRenderer(ExtendedFarmingItems.Harvester, (IItemRenderer)new ItemRendererHarvester(new EntityHarvester(FMLClientHandler.instance().getClient().theWorld), new ModelHarvester(), new ResourceLocation(ExtendedFarming.modid + ":textures/entities/Tractor2.png")));
