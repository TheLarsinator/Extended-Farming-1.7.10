...
public class ItemQuartzHoe extends ItemHoe
{
	...
	public ItemQuartzHoe(ToolMaterial p_i45343_1_) {
		super(p_i45343_1_);
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        else
        {
            ...
            if (p_77648_7_ != 0 && p_77648_3_.getBlock(p_77648_4_, p_77648_5_ + 1, p_77648_6_).isAir(p_77648_3_, p_77648_4_, p_77648_5_ + 1, p_77648_6_) && (block == Blocks.soul_sand))
            {
                Block block1 = ExtendedFarmingBlocks.FarmSoulSand;
