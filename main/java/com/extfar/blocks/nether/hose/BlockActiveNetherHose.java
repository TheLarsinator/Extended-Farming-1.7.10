...
public class BlockActiveNetherHose extends BlockNetherHoseBase implements ITileEntityProvider 
{
	public static int rotangle = new Random().nextInt(3);

	public BlockActiveNetherHose(Material rock) 
	{
		super(Material.rock);
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new TileEntityActiveNetherHose();
	}
    ...
    {
    	//world.setBlock(i, j, k, ExtendedFarmingBlocks.KillerHose);
    	System.out.println("Im beeing broken");
