...
public class BlockPassiveNetherHose extends BlockNetherHoseBase implements ITileEntityProvider 
{
	public static int rotangle = new Random().nextInt(3);

	public BlockPassiveNetherHose(Material rock) 
	{
		super(Material.rock);
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new TileEntityPassiveNetherHose();
	}
    ...
    public void randomDisplayTick(World world, int i, int j, int k, Random random) 
    {
    	if(world.getBlock(i+1, j, k) instanceof BlockActiveNetherHose)
    	{
    		...
    		world.setBlock(i, j, k, ExtendedFarmingBlocks.NetherHose, world.getBlockMetadata(i, j, k), 2);
    	}
    	if(world.getBlock(i-1, j, k) instanceof BlockActiveNetherHose)
    	{
    		world.setBlock(i-1, j, k, ExtendedFarmingBlocks.PassiveNetherHose, world.getBlockMetadata(i-1, j, k), 2);
    	...
    	if(world.getBlock(i, j-1, k) instanceof BlockActiveNetherHose)
    	{
    		world.setBlock(i, j-1, k, ExtendedFarmingBlocks.PassiveNetherHose, world.getBlockMetadata(i+1, j, k-1), 2);
    		world.setBlock(i, j, k, ExtendedFarmingBlocks.NetherHose, world.getBlockMetadata(i, j, k), 2);
    	}
    	if(world.getBlock(i, j+1, k) instanceof BlockActiveNetherHose)
    	{
    	...
    	if(world.getBlock(i, j-1, k) instanceof BlockNetherHose)
    	{
    		world.setBlock(i, j, k, ExtendedFarmingBlocks.NetherHose, world.getBlockMetadata(i, j, k), 2);
    	}
    	if(world.getBlock(i, j+1, k) instanceof BlockNetherHose)
