...
public class BlockHose extends BlockHoseBase implements ITileEntityProvider 
{
	public static int rotangle = new Random().nextInt(3);

	public BlockHose(Material rock) 
	{
		super(Material.rock);
	...
	public void onBlockPlacedBy(World world, int i, int j, int k, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
	{
		...
		{
			world.setBlock(i, j, k, ExtendedFarmingBlocks.ActiveHose, world.getBlockMetadata(i, j, k), 2);
		}
		int M = 0;
    ...
    public void randomDisplayTick(World world, int i, int j, int k, Random random) 
    {
		...
		else if((world.getBlock(i, j-1, k) == Blocks.water))
		{
			world.setBlock(i, j, k, ExtendedFarmingBlocks.ActiveHose, world.getBlockMetadata(i, j, k), 2);
		}
		int M = 0;
