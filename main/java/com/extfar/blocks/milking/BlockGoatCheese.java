...
public class BlockGoatCheese extends Block
{
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(ExtendedFarming.modid + ":" + this.getTextureName() + "_side");
        this.field_150039_M = p_149651_1_.registerIcon(ExtendedFarming.modid + ":" + this.getTextureName() + "_inner");
        this.field_150038_a = p_149651_1_.registerIcon(ExtendedFarming.modid + ":" + this.getTextureName() + "_top");
        this.field_150037_b = p_149651_1_.registerIcon(ExtendedFarming.modid + ":" + this.getTextureName() + "_bottom");
    }
